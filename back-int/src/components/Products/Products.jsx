      ...
      <div className="container ">
        {isLoading ? (
          ...
          <div className="flex-row">
            {searchValue === "" ? (
              <h1 className="py-10 text-xl text-center font-bold">Veuillez effectuer une recherche pour afficher les produits.</h1>
            ) : (
              <>
                {products.length !== 0 ? (
                  ...
                  <h1 className="py-10 text-xl text-center font-bold"></h1>
                )}
                {allProducts ? (
                  <>
                    {products.length !== 0 ? 
