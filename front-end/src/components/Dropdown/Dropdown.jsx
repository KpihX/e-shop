...
const Dropdown = ({ options, onSelect }) => {
  ...
  return (
    <div className="group relative cursor-pointer px-2 py-1">
          ...
          {isMenuOpen &&
          <ul ref={menuRef} className="flex-col items-center absolute z-[9999] group-hover:block rounded-md bg-white text-black shadow-md dark:bg-gray-900 dark:text-white">
            {options.map((option) => (
              <li 
