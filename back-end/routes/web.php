...
Route::middleware('auth:sanctum')->group(function () {
    Route::get('logout', [GestionnaireController::class, 'logout']);

    Route::get('/user', function (Request $request) {
        return $request->user();
    });
    Route::apiResource('/users', GestionnaireController::class);
});

Route::post('login', [GestionnaireController::class, 'login']);
Route::post('register', [GestionnaireController::class, 'register']);
